...
const faqs = [
    ...
    { q: "AI 영상 제작 비용은 얼마인가요?", a: "AI 영상 제작 비용은 영상 길이와 복잡도에 따라 달라집니다. 15초 SNS 광고용 라이트 패키지부터 60초 이상 브랜드 필름 프리미엄 패키지까지 다양한 옵션을 제공하며, 기존 실사 촬영 대비 약 1/3 수준의 합리적인 비용으로 제작 가능합니다. 정확한 견적은 무료 상담을 통해 안내드립니다." },
    ...
    { q: "AI로 만든 영상 품질이 실사 촬영과 비교해서 어떤가요?", a: "최신 생성형 AI 기술은 실사 촬영에 준하는 고품질 영상을 구현합니다. 특히 FOOH(가상 옥외광고), 3D 시각화, AI 모델 활용 등 기존 촬영으로는 구현이 어렵거나 비용이 과도한 장면도 합리적인 비용으로 제작할 수 있습니다. 400편 이상의 누적 제작 실적이 품질을 증명합니다." },
    ...
    { q: "유튜브 마케팅 ROAS(광고비 대비 매출)는 어느 정도인가요?", a: "함께봄의 유튜브 마케팅 캠페인은 평균 ROAS 500~2,000% 이상을 달성하고 있습니다. AI 데이터 분석을 기반으로 타겟 소비자를 정밀하게 선정하고, 영상 콘텐츠와 퍼포먼스 마케팅을 통합 운영하여 광고 효율을 극대화합니다." },
    { q: "숏폼 콘텐츠(릴스, 쇼츠, 틱톡) 제작도 가능한가요?", a: "네, 릴스·쇼츠·틱톡 등 각 SNS 플랫폼에 최적화된 15초~1분 숏폼 콘텐츠를 기획·제작합니다. 트렌드 분석을 기반으로 바이럴 확산에 최적화된 영상을 만들어 드립니다." },
    ...
    { q: "정부 지원사업이나 바우처를 활용할 수 있나요?", a: "네, 함께봄 교육&컨설팅팀에서 정부·지자체 지원사업 탐색부터 신청 컨설팅까지 지원합니다. 내일배움카드, K-디지털, AI 바우처 등 다양한 지원사업과 연계하여 교육비 부담을 줄이고 사업 성장 기회를 극대화할 수 있습니다." },
    { q: "함께봄 스튜디오는 어디에 있나요?", a: "서울 종로구 효자로7길 10 1층(서촌 한옥체)에 위치해 있습니다. 경복궁역 3번 출구에서 도보 약 10분 거리이며, 평일 10:00~19:00 운영합니다. 방문 상담도 가능하니 사전에 연락 부탁드립니다." },
];
